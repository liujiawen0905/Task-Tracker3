defmodule Spa.TasksTest do
  ...
  describe "tasks" do
    ...
    @valid_attrs %{desc: "some desc", name: "some name", status: true, time: 42}
    @update_attrs %{desc: "some updated desc", name: "some updated name", status: false, time: 43}
